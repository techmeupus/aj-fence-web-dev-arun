...
const galleryData: Record<string, string[]> = {
    "6' Black Aluminum": [
        "/services/aluminum/6 blak aluminum.avif",
        "/services/Aluminum Black.avif",
        "/services/aluminum/black ornamental road iron.avif",
        "/services/aluminum/ornamentablackaluminum.avif"
    ],
    "Aluminum 5Ft": [
        "/services/aluminum/aluminum 5ft.avif",
        "/services/Aluminum Black.avif",
        "/services/aluminum/black ornamental road iron.avif",
        "/services/aluminum/ornamentablackaluminum.avif"
    ],
    "Black Ornamental Rod Iron": [
        "/services/aluminum/black ornamental road iron.avif",
        "/services/Aluminum Black.avif",
        "/services/aluminum/aluminum 5ft.avif",
        "/services/aluminum/ornamentablackaluminum.avif"
    ],
    "Ornamental Black Aluminum": [
        "/services/Aluminum Black.avif",
        "/services/aluminum/ornamentablackaluminum.avif",
        "/services/aluminum/aluminum 5ft.avif",
        "/services/aluminum/black ornamental road iron.avif"
...
const GalleryModal = ({ isOpen, onClose, title }: { isOpen: boolean, onClose: () => void, title: string }) => {
    // Get specific images for this title, or fallback to a default set if not found
...
export default function AluminumFencingContent() {
    const router = useRouter();
    ...
    const features = [
        "Durability & Strength: Resistant to corrosion and rust, making it ideal for Florida's climate.",
        "Low Maintenance: Requires no painting or staining, just occasional cleaning.",
        "Aesthetic Appeal: Sleek, modern look that complements any property style.",
        "Security: Strong barrier that provides peace of mind without obstructing views.",
        "Value for Money: Long-lasting performance with minimal upkeep costs."

    ];

    const options = [
        {
            title: "6' Black Aluminum",
            img: "/services/aluminum/6 blak aluminum.avif",
            description: "A standard-height residential aluminum fence provides security and durability with a clean, classic look."
        },
        {
            title: "Aluminum 5Ft",
            img: "/services/aluminum/aluminum 5ft.avif",
            description: "Slightly shorter for a more open feel, perfect for pool enclosures and perimeter marking."
        },
        {
            title: "Black Ornamental Rod Iron",
            img: "/services/aluminum/black ornamental road iron.avif",
            description: "The premium look of wrought iron with the modern benefits of zero-maintenance aluminum."
        },
        {
            title: "Ornamental Black Aluminum",
            img: "/services/aluminum/ornamentablackaluminum.avif",
            description: "Intricate designs and elegant finials that add significant curb appeal to any property."
        }
    ];
                        ...
                        <ScrollReveal delay={0.3} type="fade-up">
                            <div className="max-w-3xl">
                                ...
                                <p className="text-xl md:text-2xl text-[#e4c58a] italic leading-relaxed mb-10 lg:mb-0">
                                    Premium, durable, and elegant fencing solutions that stand the test of time. Perfect for security and aesthetic enhancement.
                                </p>
                        ...
                        <ScrollReveal type="slide-left" duration={1}>
                            <div>
                                ...
                                <p className="text-gray-700 text-lg mb-8 leading-relaxed">
                                    Aluminum fencing offers the perfect blend of beauty and functionality. Unlike traditional materials, it won&apos;t rust, rot, or fade over time. It provides a high-end look similar to wrought iron but at a fraction of the cost and maintenance.
                                </p>
                    ...
                    <ScrollReveal type="fade-up">
                        <div className="text-center mb-16 max-w-4xl mx-auto">
                            ...
                            <p className="text-[#4c0c0c] font-poppins italic text-xl">
                                Click on any style to view our gallery of completed projects.
                            </p>
                        </div>
                    </ScrollReveal>
