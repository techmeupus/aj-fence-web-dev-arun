...
const galleryData: Record<string, string[]> = {
    "Shadow Box Arched": [
        "/services/wood/Shadow-box-arched.avif",
        "/services/wood/shadow-box-6'.avif"
    ],
    "Stockade": [
        "/services/wood/stockade.avif",
        "/services/wood/stockade-w-t-top.avif"
    ],
    "Cross-buck": [
        "/services/wood/corss-buck.avif"
    ],
    "Cross-buck w/ Field fence": [
        "/services/wood/cross-buck-w-field-fence.avif",
        "/services/wood/corss-buck.avif"
    ],
    "Stockade w/ T-Top": [
        "/services/wood/stockade-w-t-top.avif",
    ...
    "Board On Board": [
        "/services/wood/board-on-board.avif",
        "/services/wood/b.b..avif",
        "/services/wood/b.b2.avif",
        "/services/wood/board-on-board-6'-pressure-treated-pickets.avif",
        "/services/wood/board-on-board-6'-pressure-treated-picket2.avif",
        "/services/wood/board-on-board-6'-pressure-treated-pickets-with-3-rails.avif"
    ],
    "8' Stockade Horizontal": [
        "/services/wood/8'-stockade-horizontal.avif"
    ],
    "B.B. Arched": [
        "/services/wood/b.b.arched.avif",
        "/services/wood/b.b..avif"
    ],
    "Shadow Box 6'": [
        "/services/wood/shadow-box-6'.avif",
...
export default function WoodFencingContent() {
    const router = useRouter();
    ...
    const features = [
        "Natural Beauty: The timeless look and feel of real wood that complements any landscape.",
        "Customizable: Can be stained or painted in nearly any color to match your property.",
        "Complete Privacy: Solid wood panels offer a high level of seclusion and security.",
        "Value: Cost-effective and durable solution with proper treatment and maintenance.",
        "Versatile Designs: From classic stockade to decorative shadow box and picket styles."
    ];

    const options = [
        {
            title: "Shadow Box Arched",
            img: "/services/wood/Shadow-box-arched.avif",
            description: "A beautiful arched design that offers privacy while allowing airflow through the panels."
        },
        {
            title: "Stockade",
            img: "/services/wood/stockade.avif",
            description: "The classic privacy fence featuring solid vertical boards for a traditional, secure look."
        },
        {
            title: "Cross-buck",
            img: "/services/wood/corss-buck.avif",
            description: "An elegant ranch-style fence with decorative X-bracing for a rustic, high-end feel."
        },
        {
            title: "Cross-buck w/ Field fence",
            img: "/services/wood/cross-buck-w-field-fence.avif",
            description: "Combines the rustic cross-buck style with wire mesh for extra pet and animal security."
        },
        {
            title: "Stockade w/ T-Top",
            img: "/services/wood/stockade-w-t-top.avif",
            description: "Standard stockade privacy with a decorative top rail for a more finished, architectural appearance."
        },
        {
            title: "Board On Board",
            img: "/services/wood/board-on-board-6'-pressure-treated-picket2.avif",
            description: "Overlapping boards that ensure zero visibility gaps even as the wood naturally expands and contracts."
        },
        {
            title: "8' Stockade Horizontal",
            img: "/services/wood/8'-stockade-horizontal.avif",
            description: "A modern take on the traditional stockade, utilizing horizontal boards for a sleek contemporary look."
        },
        {
            title: "B.B. Arched",
            img: "/services/wood/b.b.arched.avif",
            description: "A decorative arched board-on-board design that adds elegance and maximum privacy."
        },
        {
            title: "Shadow Box 6'",
            img: "/services/wood/shadow-box-6'.avif",
            description: "A sturdy 6-foot tall shadow box fence providing privacy with a dimensional, textured aesthetic."
        }
    ];
                        ...
                        <ScrollReveal delay={0.3} type="fade-up">
                            <div className="max-w-3xl">
                                ...
                                <p className="text-xl md:text-2xl text-[#e4c58a] italic leading-relaxed mb-10 lg:mb-0">
                                    Natural, timeless, and fully customizable. Bring warmth and privacy to your home with our premium wood fencing solutions.
                                </p>
                        ...
                        <ScrollReveal type="slide-left" duration={1}>
                            <div>
                                <h2 className="text-4xl md:text-5xl font-bold text-[#4c0c0c] mb-8">
                                    The Charm of Real Wood
                                </h2>
                                <p className="text-gray-700 text-lg mb-8 leading-relaxed">
                                    Wood fencing remains one of the most popular choices for its versatility and natural aesthetic. The durability of pressure-treated pine, wood fencing adds a unique character to your property that other materials simply can&apos;t match. From complete privacy to decorative boundaries, our wood fences are built to last.
                                </p>
                    ...
                    <ScrollReveal type="fade-up">
                        <div className="text-center mb-16 max-w-4xl mx-auto">
                            ...
                            <p className="text-[#4c0c0c] font-poppins italic text-xl">
                                Discover our wide range of decorative and functional wood fencing styles.
                            </p>
                        </div>
                    </ScrollReveal>
