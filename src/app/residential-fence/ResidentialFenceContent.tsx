...
import { CheckCircle2, Home, Star, Palette, Shield, X } from "lucide-react";
...
export default function ResidentialFenceContent() {
    const router = useRouter();
        ...
        <main>
            ...
            <section className="relative min-h-[85vh] md:h-[90vh] w-full flex items-center overflow-hidden py-20 md:py-0">
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        alt="Quality Residential Fencing"
                        fill
                        ...
                        <ScrollReveal delay={0.3} type="fade-up">
                            <div className="max-w-4xl">
                                ...
                                <p className="text-xl md:text-2xl text-[#e4c58a] font-poppins italic leading-relaxed mb-10 lg:mb-0">
                                    Enhancing your home's character, privacy, and functional security.
                                </p>
                    ...
                    <ScrollReveal delay={0.2} type="fade-up">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-5xl font-bold text-[#4c0c0c] mb-8 italic">
                                What Should You Look for in Residential Fence Installation?
                            </h2>
                            <p className="text-gray-700 text-lg leading-relaxed mb-10">
                                When choosing to add a residential fence, think about what you want that fence to offer to you. Do you want to add character and architectural details? Or do you need a functional fence for pets and wildlife? No matter your goals, working with a team that offers plenty of options is the best way to start.
                            </p>
                        ...
                        <ScrollReveal type="slide-left" duration={1}>
                            <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                                <Image
                                    ...
                                    alt="Defining Your Fencing Needs"
                                    fill
                                    className="object-cover"
                                />
                            </div>
                        ...
                        <ScrollReveal type="slide-right" duration={1}>
                            <div>
                                <h2 className="text-3xl md:text-4xl font-bold text-[#4c0c0c] mb-8 italic">
                                    Define Your Needs in a Fence
                                </h2>
                                <p className="text-gray-700 text-lg mb-8 leading-relaxed">
                                    Choosing a residential fence based on how it needs to work for you is essential. Whether you prioritize privacy, security, or a decorative feature, we provide a wide range of materials and styles to ensure you get the exact benefits you're looking for.
                                </p>
                                <div className="space-y-4">
                                    <div className="flex items-center gap-3">
                                        <Home className="text-[#4c0c0c]" size={24} />
                                        <p className="text-gray-800 font-medium">Custom Architectural Details</p>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <Shield className="text-[#4c0c0c]" size={24} />
                                        <p className="text-gray-800 font-medium">Functional Security for Pets</p>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <CheckCircle2 className="text-[#4c0c0c]" size={24} />
                                        <p className="text-gray-800 font-medium">Privacy and Outdoor Comfort</p>
                                    </div>
                                </div>
                            </div>
                        </ScrollReveal>
                        ...
                        <ScrollReveal type="fade-up">
                            <div>
                                <h2 className="text-3xl md:text-4xl font-bold mb-8 italic text-[#e4c58a]">
                                    Choose Fence with Character
                                </h2>
                                <p className="text-white/90 text-lg leading-relaxed mb-10">
                                    A residential fence should be more than just a boundary – it should be beautiful. Decorator fencing solutions add interest and character to your home, increasing value and curb appeal even if total privacy isn't your primary requirement.
                                </p>
                                <div className="flex gap-4 items-center">
                                    <div className="p-4 bg-white/10 rounded-2xl border border-white/20">
                                        <Palette className="text-[#e4c58a]" size={32} />
                                    </div>
                                    <div>
                                        <h4 className="text-xl font-bold font-poppins text-[#e4c58a]">Visual Excellence</h4>
                                        <p className="text-sm text-white/70">Adding a stunning visual element to your landscape.</p>
                                    </div>
                                </div>
                            </div>
                        </ScrollReveal>
                        <ScrollReveal type="fade-up" delay={0.2}>
                            <div className="relative h-[500px] rounded-3xl overflow-hidden border-4 border-[#e4c58a]/20 shadow-2xl">
                                <Image
                                    ...
                                    alt="Decorative Residential Fencing"
                                    fill
                                    className="object-cover"
                                />
                            </div>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <ScrollReveal type="fade-up">
                        <h2 className="text-3xl md:text-5xl font-bold text-[#4c0c0c] mb-8 italic">
                            Choose a Company Dedicated to Results
                        </h2>
                        <p className="text-xl text-gray-700 leading-relaxed mb-12">
                            Pay close attention to your unique goals, the level of experience of the provider, and the range of fence options offered. At AJ FENCE, we are committed to delivering the best results for your home.
                        </p>
                        <div className="inline-flex items-center gap-2 p-4 px-8 bg-[#e4c58a]/10 rounded-full border border-[#e4c58a]/20">
                            <Star className="text-[#4c0c0c] fill-[#4c0c0c]" size={20} />
                            <span className="text-[#4c0c0c] font-bold font-poppins">Ready for a free quote? reached out to us today!</span>
                        </div>
                    </ScrollReveal>
                </div>
            </section>
